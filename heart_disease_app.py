...
def main():
    ...
    cp = st.selectbox("Chest Pain Type (cp)", options=[1, 2, 3, 4], index=predefined_data["cp"])
    ...
    slope = st.selectbox("Slope of the Peak Exercise ST Segment (slope)", options=[ 1, 2,3], index=predefined_data["slope"])
